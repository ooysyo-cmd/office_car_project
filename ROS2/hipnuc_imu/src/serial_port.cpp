			...
			for(int i = 0; i < n; i++)
			{
				...
				if(rev)
				{
					...
					imu_data.angular_velocity_covariance = {
						1.800e-07, 2.111e-09, -1.250e-09,
						2.111e-09, 1.988e-07, 2.908e-10,
						-1.250e-09, 2.908e-10, 2.001e-07};
					imu_data.linear_acceleration_covariance = {
						2.604e-05, 1.380e-05, 2.707e-07,
						1.380e-05, 3.992e-05, 3.064e-06,
						2.707e-07, 3.064e-06, 2.878e-05};
					// orientation 有输出（hi91有quat），填实测值或对角矩阵
